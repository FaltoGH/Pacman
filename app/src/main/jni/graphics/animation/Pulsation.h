...
private:
	...
	constexpr static const float FI_DELTA = 0.001f;
	constexpr static const float MAX_FI_ABS = 1.0f;
	constexpr static const int BRUSHES_COUNT = 16;
	constexpr static const double DEFAULT_DURATION = 60.0;
